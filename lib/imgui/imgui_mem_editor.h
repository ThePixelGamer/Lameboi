...
struct MemoryEditor
{
	...
	void*			DataContent[255];
    size_t          DataContentSize[255];
	u8				LastContent;
    ...
    MemoryEditor()
    {
        ...
        memset(DataContentSize, 0, sizeof(DataContentSize));
		LastContent = 0;
    }
	...
	void AddData(void* mem_data_void_ptr, size_t mem_size) {
		DataContent[LastContent] = mem_data_void_ptr;
		DataContentSize[LastContent] = mem_size;
		LastContent++;
	}
